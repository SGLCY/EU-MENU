...
# 
## b) MTX_10.xlsx - You get this from the (updated .ecf file (catalog) and the new Catalogue Browser)
#
...
# via install.packages("package_name")]
...
# Read the files ####
  ...
  mapping_df <- read_xlsx("MTX_10.0.xlsx", 
                          sheet = "term") %>%
